defmodule RestaurantAccess.Access.LteQueries do
  @moduledoc """
  Alternative implementation of hierarchical queries using PostgreSQL `ltree`.

  This module is provided as an optimization example. The primary solution
  uses recursive CTEs, as required by the task specification.
  """
  import Ecto.Query
